...
=end
    def test_get_results
      puts 'get results'
      #get '/api/xschmctl/results?dir=C%3A%5CUsers%5Cseiji%5CSeafile%5CLSI_devel%5CLR_homework%5Clr_noda%2F&file=NAND.sch&probes=time%2C%20V(a)%2C%20V(b)%2C%20V(y)&equation=x.where(y%2C%202.5)%7B%7Cx%2C%20y%7C%20x%20%3E%201e-6%7D'
